...
- (void)startIndex:(NSInteger)index ids:(NSArray<NSString *> *)ids repeatMode:(RepeatMode)repeatMode shuffleMode:(ShuffleMode)shuffleMode error:(FlutterError *_Nullable *_Nonnull)error;
- (void)startAllSongsIndex:(NSInteger)index repeatMode:(RepeatMode)repeatMode shuffleMode:(ShuffleMode)shuffleMode error:(FlutterError *_Nullable *_Nonnull)error;
- (void)startAlbumSongsIndex:(NSInteger)index albumId:(NSString *)albumId repeatMode:(RepeatMode)repeatMode shuffleMode:(ShuffleMode)shuffleMode error:(FlutterError *_Nullable *_Nonnull)error;
- (void)startArtistSongsIndex:(NSInteger)index artistId:(NSString *)artistId repeatMode:(RepeatMode)repeatMode shuffleMode:(ShuffleMode)shuffleMode error:(FlutterError *_Nullable *_Nonnull)error;
