  ...
  messageChannelSuffix = messageChannelSuffix.length > 0 ? [NSString stringWithFormat: @".%@", messageChannelSuffix] : @"";
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        ...
        codec:nullGetAudioCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(startIndex:ids:repeatMode:shuffleMode:error:)], @"PlayerHostApi api (%@) doesn't respond to @selector(startIndex:ids:repeatMode:shuffleMode:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        NSInteger arg_index = [GetNullableObjectAtIndex(args, 0) integerValue];
        NSArray<NSString *> *arg_ids = GetNullableObjectAtIndex(args, 1);
        RepeatModeBox *boxedRepeatMode = GetNullableObjectAtIndex(args, 2);
        RepeatMode arg_repeatMode = boxedRepeatMode.value;
        ShuffleModeBox *boxedShuffleMode = GetNullableObjectAtIndex(args, 3);
        ShuffleMode arg_shuffleMode = boxedShuffleMode.value;
        FlutterError *error;
        [api startIndex:arg_index ids:arg_ids repeatMode:arg_repeatMode shuffleMode:arg_shuffleMode error:&error];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        ...
        codec:nullGetAudioCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(startAllSongsIndex:repeatMode:shuffleMode:error:)], @"PlayerHostApi api (%@) doesn't respond to @selector(startAllSongsIndex:repeatMode:shuffleMode:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        NSInteger arg_index = [GetNullableObjectAtIndex(args, 0) integerValue];
        RepeatModeBox *boxedRepeatMode = GetNullableObjectAtIndex(args, 1);
        RepeatMode arg_repeatMode = boxedRepeatMode.value;
        ShuffleModeBox *boxedShuffleMode = GetNullableObjectAtIndex(args, 2);
        ShuffleMode arg_shuffleMode = boxedShuffleMode.value;
        FlutterError *error;
        [api startAllSongsIndex:arg_index repeatMode:arg_repeatMode shuffleMode:arg_shuffleMode error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        ...
        codec:nullGetAudioCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(startAlbumSongsIndex:albumId:repeatMode:shuffleMode:error:)], @"PlayerHostApi api (%@) doesn't respond to @selector(startAlbumSongsIndex:albumId:repeatMode:shuffleMode:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        NSInteger arg_index = [GetNullableObjectAtIndex(args, 0) integerValue];
        ...
        ShuffleMode arg_shuffleMode = boxedShuffleMode.value;
        FlutterError *error;
        [api startAlbumSongsIndex:arg_index albumId:arg_albumId repeatMode:arg_repeatMode shuffleMode:arg_shuffleMode error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        ...
        codec:nullGetAudioCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(startArtistSongsIndex:artistId:repeatMode:shuffleMode:error:)], @"PlayerHostApi api (%@) doesn't respond to @selector(startArtistSongsIndex:artistId:repeatMode:shuffleMode:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        NSInteger arg_index = [GetNullableObjectAtIndex(args, 0) integerValue];
        ...
        ShuffleMode arg_shuffleMode = boxedShuffleMode.value;
        FlutterError *error;
        [api startArtistSongsIndex:arg_index artistId:arg_artistId repeatMode:arg_repeatMode shuffleMode:arg_shuffleMode error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
...
- (void)onErrorMessage:(NSString *)arg_message completion:(void (^)(FlutterError *_Nullable))completion {
  NSString *channelName = [NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.thinmpf.PlayerFlutterApi.onError", _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:channelName
      binaryMessenger:self.binaryMessenger
