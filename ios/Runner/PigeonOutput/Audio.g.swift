...
func deepEqualsAudio(_ lhs: Any?, _ rhs: Any?) -> Bool {
  ...
  case let (cleanLhsArray, cleanRhsArray) as ([Any?], [Any?]):
    ...
    for (index, element) in cleanLhsArray.enumerated() {
      if !deepEqualsAudio(element, cleanRhsArray[index]) {
        return false
      }
    }
    return true
  ...
  case let (cleanLhsDictionary, cleanRhsDictionary) as ([AnyHashable: Any?], [AnyHashable: Any?]):
    ...
    for (key, cleanLhsValue) in cleanLhsDictionary {
      ...
      if !deepEqualsAudio(cleanLhsValue, cleanRhsDictionary[key]!) {
        return false
      }
    }
    return true
...
func deepHashAudio(value: Any?, hasher: inout Hasher) {
  if let valueList = value as? [AnyHashable] {
     for item in valueList { deepHashAudio(value: item, hasher: &hasher) }
     return
  }
  ...
  if let valueDict = value as? [AnyHashable: AnyHashable] {
    for key in valueDict.keys { 
      hasher.combine(key)
      deepHashAudio(value: valueDict[key]!, hasher: &hasher)
    }
    return
  }
...
struct SongDTO: Hashable {
  ...
  static func == (lhs: SongDTO, rhs: SongDTO) -> Bool {
    return deepEqualsAudio(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashAudio(value: toList(), hasher: &hasher)
  }
}
...
struct AlbumDTO: Hashable {
  ...
  static func == (lhs: AlbumDTO, rhs: AlbumDTO) -> Bool {
    return deepEqualsAudio(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashAudio(value: toList(), hasher: &hasher)
  }
...
/// Generated class from Pigeon that represents data sent in messages.
struct ArtistDetailDTO: Hashable {
  var id: String
  var name: String
  var imageId: String
  ...
  static func == (lhs: ArtistDetailDTO, rhs: ArtistDetailDTO) -> Bool {
    return deepEqualsAudio(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashAudio(value: toList(), hasher: &hasher)
  }
