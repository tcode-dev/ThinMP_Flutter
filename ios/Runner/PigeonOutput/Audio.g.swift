...
struct Song {
  ...
  static func fromList(_ __pigeon_list: [Any?]) -> Song? {
    ...
    let albumName = __pigeon_list[3] as! String
    let artistId = __pigeon_list[4] as! String
    let artistName = __pigeon_list[5] as! String
    let imageId = __pigeon_list[6] as! String
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: PlayerHostApi?, messageChannelSuffix: String = "") {
    ...
    if let api = api {
      startChannel.setMessageHandler { message, reply in
        ...
        do {
          try api.start(index: indexArg, ids: idsArg)
