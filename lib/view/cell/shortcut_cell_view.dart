...
class ShortcutCellWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final secondaryText = shortcut.type == ShortcutItemType.artist ? 'Artist' : shortcut.type == ShortcutItemType.album ? 'Album' : 'Playlist';
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        return Column(
          ...
          children: [
            SquareImageWidget(id: shortcut.imageId, size: constraints.maxWidth),
            SizedBox(
